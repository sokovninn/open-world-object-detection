...
data = np.load("./data_nodet.npz")
print(data['embs'].shape)
in_embs = data['embs'][:500]
out_embs = data['embs'][500:1000]

in_targets = data['targets'][:500]
out_targets = data['targets'][500:1000]
